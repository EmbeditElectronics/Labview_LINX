...
void CapSense_1_SetAllSensorsDriveMode(uint8 mode) 
{
    ...
    CyPins_SetPinDriveMode(CapSense_1_PortCH0__Button3__BTN, mode);
    CyPins_SetPinDriveMode(CapSense_1_PortCH0__Button4__BTN, mode);
    CyPins_SetPinDriveMode(CapSense_1_PortCH0__Button5__BTN, mode);
    CyPins_SetPinDriveMode(CapSense_1_PortCH0__Button6__BTN, mode);
    CyPins_SetPinDriveMode(CapSense_1_PortCH0__Button7__BTN, mode);
